...
if [ $FAIL -eq 0 ]; then
    echo ${DELIMITER}
    echo -e "${GREEN}s21_cat tests SUCCEEDED!${RESET}"
    echo ${DELIMITER}
    echo "s21_cat tests SUCCEEDED" > ../s21_cat_result.txt
    rm -rf ${CAT_OUTPUT} ${S21_CAT_OUTPUT}
else
    echo ${DELIMITER}Ц
    echo -e "${RED}s21_cat tests FAILED!${RESET}"
    echo ${DELIMITER}
    echo "s21_cat tests FAILED" > ../s21_cat_result.txt
    rm -rf ${CAT_OUTPUT} ${S21_CAT_OUTPUT}
